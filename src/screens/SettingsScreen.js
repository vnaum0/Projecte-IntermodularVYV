...
export default function SettingsScreen() {
  ...
  const renderArrow = (section) => {
    const rotate = arrowAnim[section]
      ...
      : "0deg";
    return <Animated.Text style={{ transform: [{ rotate }], fontSize: 18, color: theme.sectionTitle.color }}>{">"}</Animated.Text>;
  };
  ...
  return (
    <SafeAreaProvider>
      <SafeAreaView style={[styles.safeArea, { backgroundColor: isDarkMode ? "#121212" : "#fff" }]}>
        ...
        >
          <ScrollView contentContainerStyle={[theme.container, { backgroundColor: isDarkMode ? "#121212" : "#fff" }]}>
...
// Estilos base
const baseStyles = { sectionHeader: { flexDirection: "row", justifyContent: "space-between", alignItems: "center" }, smallText: { fontSize: 12, opacity: 0.6 } };
