...
const styles = StyleSheet.create({
  ...
  timeInput: { borderWidth: 1, width: 60, textAlign: 'center', borderRadius: 8, padding: 5 },
  priceRow: { flexDirection: 'row', justifyContent: 'space-between', marginVertical: 10 },
  priceBtn: { padding: 10, borderWidth: 1, borderRadius: 20, width: 70, alignItems: 'center' },
  imagePicker: { borderWidth: 1, padding: 20, alignItems: 'center', borderRadius: 8, marginVertical: 10 },
  galleryImg: { width: 100, height: 80, borderRadius: 8, marginRight: 10 },
  saveBtn: { backgroundColor: 'blue', padding: 15, borderRadius: 8, alignItems: 'center', marginVertical: 20 }
});